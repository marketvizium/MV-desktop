<template>
  <div class="card">
        ...
        <div class="expansion-container">
          <div class="details-grid">
            ...
            <div class="option-card">
              <h4 class="option-title title-1">Vendas e Abertura</h4>
            ...
            <div class="option-card">
              <h4 class="option-title title-2">Movimentação de Caixa</h4>
              <div class="info-row">
                <div class="info-group">
    ...
    <div v-if="loading" class="loading-container">
      ...
      <span class="muted mt-2">Buscando turnos de hoje...</span>
    </div>
    ...
    <div v-else-if="!loading && turnosFiltrados.length === 0" class="empty-container">
      ...
      <div class="poppins-regular">Nenhum turno encontrado para hoje...</div>
    </div>
  </div>
</template>
...
.user-text { color: #5A0F83; font-weight: 600; }
...
.info-group { display: flex; flex-direction: column; flex: 1; min-width: 80px; }
...
.obs-text { font-style: italic; color: #475569; font-size: 13px; }
