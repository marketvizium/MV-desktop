<template>
  <div class="card">
        ...
        <div class="expansion-container">
          <div class="details-grid">
            ...
            <div class="option-card">
              <h4 class="option-title title-1">Dados de Entrada</h4>
            ...
            <div class="option-card">
              <h4 class="option-title title-2">Movimentação Financeira</h4>
              <div class="info-row">
                <div class="info-group">
            ...
            <div class="option-card full-width">
              <h4 class="option-title title-3">Observações do Turno</h4>
              <p class="value obs-text">{{ data.observacoes || 'Nenhuma observação registrada para este turno.' }}</p>
            </div>
    ...
    <div v-if="loading" class="loading-container">
      ...
      <span class="muted mt-2">Analisando turnos em revisão...</span>
    </div>
    ...
    <div v-else-if="!loading && turnosFiltrados.length === 0" class="empty-container">
      ...
      <div class="poppins-regular">Nenhum turno em revisão encontrado...</div>
    </div>
  </div>
</template>
...
.obs-text { font-style: italic; line-height: 1.5; color: #475569; }
