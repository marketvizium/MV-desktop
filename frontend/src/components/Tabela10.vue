<template>
  <div class="card">
    ...
    >
      ...
      <Column header="Início / Fim">
        <template #body="{ data }">
          <div class="flex flex-column gap-1">
            <span class="text-xs text-muted">INÍ: {{ formatarDataHora(data.inicio_em) }}</span>
            <span class="text-xs text-muted">FIM: {{ formatarDataHora(data.fim_em) }}</span>
          </div>
        </template>
      </Column>
      ...
      <Column header="Fechamento">
        <template #body="{ data }">
          <span class="font-bold text-indigo">R$ {{ data.valor_fechamento?.toFixed(2) }}</span>
        </template>
      </Column>
        ...
        <div class="expansion-container">
          <div class="details-grid">
            ...
            <div class="option-card">
              <h4 class="option-title title-1">Identificação e Abertura</h4>
              ...
              <div class="info-row mt-3">
                ...
                <div class="info-group">
                  <span class="label">Resp. Fechamento</span>
            ...
            <div class="option-card">
              <h4 class="option-title title-2">Movimentação de Vendas</h4>
              <div class="info-row">
                <div class="info-group">
            ...
            <div class="option-card full-width">
              ...
              <p class="value obs-text">{{ data.observacoes || 'Sem observações registradas.' }}</p>
            </div>
    ...
    <div v-if="loading" class="loading-container">
      ...
      <span class="muted mt-2">Buscando turnos fechados...</span>
    </div>
    ...
    <div v-else-if="!loading && turnosFiltrados.length === 0" class="empty-container">
      ...
      <div class="poppins-regular">Nenhum turno fechado encontrado...</div>
    </div>
  </div>
</template>
