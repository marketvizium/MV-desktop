<template>
  <div class="totalPage">
    <TitileSubtitle
      ...
      subtitle="Selecione uma cotação aberta ou finalizada para consultar o histórico de itens adicionados e ofertas."
    />
    ...
    <div class="cards-wrapper">
      ...
      >
        ...
        <div class="card-content nome-user">
